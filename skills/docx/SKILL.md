---
name: docx
description: Use this skill any time a .docx or .doc file is involved — creating, editing, analyzing, or converting Word documents. Trigger when users mention "Word document," "docx," "tracked changes," or ask to create formatted documents with headings, tables, lists, footnotes, or complex formatting.
---
...
**Landscape orientation:** pass portrait dimensions and let docx-js handle the swap:
```javascript
size: {
...
- **Never use tables as dividers/rules** — use paragraph borders instead
